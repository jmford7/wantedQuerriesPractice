...
module.exports = {
    ...
    'Submit a valid query Enter (Happy Path)': browser => {
        ...
        .pause(5000)
        .click('@clickEnter')
        .setEnterFields('1234567890','ABC.','OAI123456','Harry Dresden','M','B','607','225','Brown','Arson','02312018') // want to modify this into an variety of objects to call (add max, min, mid range values)
        .pause(5000)
        .click('@saveBtn')
    ...
    'Submit an invalid query Enter': browser => {
        ...
        .pause(5000)
        .click('@clickEnter')
        .setEnterFields('102345678901233548977451125588784','4444','OAI12345$','Harry Dresden','M','B','6d','2lb','Brown$S','Arson','10312010') // want to modify this into a variety of invalid objects (blank, more than max, chars not allowed, add appropriate expect verifications and cycle through)
        .pause(5000)
        .click('@saveBtn')
